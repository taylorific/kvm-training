...
# Ubuntu Desktop 26.04 manual install
...
## Download ISO - Ubuntu Desktop 26.04

```bash
mkdir -p ubuntu-desktop2604
cd ubuntu-desktop2604
```

```bash
$ curl -LO https://releases.ubuntu.com/resolute/ubuntu-26.04-desktop-amd64.iso
...
## Test in a VM - Ubuntu Desktop 26.04 autoinstall

```bash
export UBUNTU_DESKTOP_ISO="ubuntu-26.04-desktop-amd64.iso"
...
export VM_VCPU=4
export VM_NETWORK=host-network
virsh vol-create-as images "$VM_NAME.qcow2" 64G --format qcow2
